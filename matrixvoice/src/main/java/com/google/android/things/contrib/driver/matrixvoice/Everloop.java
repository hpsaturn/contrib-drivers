...
/**
 *  Driver for the MatrixVoice everloop ring LED.
 */
public class Everloop implements AutoCloseable {
     ...
     * @throws IOException
     */
    public Everloop(String bus) throws IOException {
        PeripheralManager pioService = PeripheralManager.getInstance();
        mDevice = pioService.openI2cDevice(bus, MatrixVoice.I2C_ADDRESS);
    }

    /* package */ Everloop(I2cDevice device) {
        mDevice = device;
    }
